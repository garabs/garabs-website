  ...
  head: () => ({
    meta: [
      ...
      { title: "GARABS LLC — Presencia digital para negocios pequeños" },
      {
        name: "description",
        content:
          "GARABS ayuda a pequeños negocios y emprendedores a crear, organizar y administrar su presencia digital.",
      },
      { property: "og:site_name", content: "GARABS LLC" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#132039" },
    ],
    links: [
